...
LV_Imgs::LV_Imgs(QWidget *parent) : QListView(parent) {
...
QString LV_Imgs::MyMimeType() {
    return QStringLiteral("application/x-my-lv-img-mimetype");
}

void LV_Imgs::init(void) {
...
// */
//void LV_Imgs::btn_add_lasttag_clicked(void) {
...
// * Add selected tags
// */
//void LV_Imgs::btn_add_selected_tags_clicked(void) {
//    dia1->close();
...
////void LV_Imgs::refresh_items(std::vector<QStandardItem*> items) {
...
////void LV_Imgs::refresh_imgs(std::vector<Img> imgs) {
////    for (Img img : imgs) {
//////        QStandardItem *item = model->itemFromIndex(qmi);
////        QVariant qv = item->data(Qt::UserRole);
////        Img img = qv.value<Img>();
...
////int LV_Imgs::get_tagid_from_qmi(QModelIndex qmi) {
//////    QModelIndex k = indexes.at(0);
...
// * Copy date
// */
//void LV_Imgs::btn_copy_date_clicked(void) {
//    dia1->close();
...
//void LV_Imgs::btn_loadimages_clicked(void) {
//    // load images
//    dia1->close();
...
// * YYYY-MM-DD
// */
//void LV_Imgs::btn_paste_date_clicked(void) {
...
//void LV_Imgs::btn_remove_tag_clicked(void) {
...
// * Remove tags
// */
//void LV_Imgs::btn_remove_tags_clicked(void) {
//    dia1->close();
...
// */
//void LV_Imgs::btn_rotate_clicked(void) {
//    dia1->close();
...
// * YYYY-MM-DD
// */
//void LV_Imgs::btn_set_date_clicked(void) {
...
// */
//void LV_Imgs::btn_showuntagged_clicked(void) {
...
//void LV_Imgs::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight, const QVector<int> &roles) {
//    //    std::cerr << "debug - line: " << __LINE__ << " - file: " << __FILE__ << std::endl;
////    mydebug2(__LINE__,__FILE__);
////    MYDEB ;
...
//void LV_Imgs::dragEnterEvent(QDragEnterEvent *event) {
////    MYDEB ;
////    std::cerr << "debug - line: " << __LINE__ << " - file: " << __FILE__ << std::endl;
...
//void LV_Imgs::dragMoveEvent(QDragMoveEvent *event) {
//    event->acceptProposedAction();
//}

//void LV_Imgs::dropEvent(QDropEvent *event) {
...
//void LV_Imgs::startDrag(Qt::DropActions /*supportedActions*/) {
...
//std::vector<int> LV_Imgs::get_selected_ids(void) {
//    std::vector<int> ids;
//    QModelIndexList indexes = selectionModel()->selectedIndexes();
...
// */
//void LV_Imgs::set_date_to_selected(std::string date) {
//    if (!MyDate::isValid(date)) {
//        QMessageBox msgBox;
...
//void LV_Imgs::mousePressEvent(QMouseEvent *e) {
//    //    std::cerr << "debug - line: " << __LINE__ << " - file: " << __FILE__ << std::endl;
...
//        connect(btn_addtolasttag, &QPushButton::clicked, this, &LV_Imgs::btn_add_lasttag_clicked);
...
//        connect(btn_addtomarkedtag, &QPushButton::clicked, this, &LV_Imgs::btn_add_selected_tags_clicked);

//        // button remove from tag
//        QPushButton *btn_removefromtag = new QPushButton("remove current tag");
//        lay1->addWidget(btn_removefromtag);
//        connect(btn_removefromtag, &QPushButton::clicked, this, &LV_Imgs::btn_remove_tag_clicked);

//        // button remove tags
//        QPushButton *btn_removetags = new QPushButton("remove tags");
//        lay1->addWidget(btn_removetags);
//        connect(btn_removetags, &QPushButton::clicked, this, &LV_Imgs::btn_remove_tags_clicked);

//        // button rotate
//        QPushButton *btn_rotate = new QPushButton("rotate");
//        lay1->addWidget(btn_rotate);
//        connect(btn_rotate, &QPushButton::clicked, this, &LV_Imgs::btn_rotate_clicked);

//        // button set date
//        QPushButton *btn_set_date = new QPushButton("set date");
//        lay1->addWidget(btn_set_date);
//        connect(btn_set_date, &QPushButton::clicked, this, &LV_Imgs::btn_set_date_clicked);

//        // button copy date
//        QPushButton *btn_copy_date = new QPushButton("copy date");
//        lay1->addWidget(btn_copy_date);
//        connect(btn_copy_date, &QPushButton::clicked, this, &LV_Imgs::btn_copy_date_clicked);

//        // button paste date
//        QPushButton *btn_paste_date = new QPushButton("paste date");
//        lay1->addWidget(btn_paste_date);
//        connect(btn_paste_date, &QPushButton::clicked, this, &LV_Imgs::btn_paste_date_clicked);

//        // load images
//        QPushButton *btn_loadimages = new QPushButton("load images");
//        lay1->addWidget(btn_loadimages);
//        connect(btn_loadimages, &QPushButton::clicked, this, &LV_Imgs::btn_loadimages_clicked);

//        // show untagged images
//        QPushButton *btn_showuntagged = new QPushButton("show untagged images");
//        lay1->addWidget(btn_showuntagged);
//        connect(btn_showuntagged, &QPushButton::clicked, this, &LV_Imgs::btn_showuntagged_clicked);

//        // test
//        QPushButton *btn_test = new QPushButton("test");
//        lay1->addWidget(btn_test);
//        connect(btn_test, &QPushButton::clicked, this, &LV_Imgs::mytest);

//        //        // button note edit
//        //        QPushButton *btn_noteedit = new QPushButton("note edit");
//        //        lay1->addWidget(btn_noteedit);
//        //        connect(btn_noteedit, &QPushButton::clicked, this, &LV_Imgs::btn_noteedit);
...
//void LV_Imgs::on_lv_img_doubleClicked(const QModelIndex &index) {
////    std::cerr << "debug - line: " << __LINE__ << " - file: " << __FILE__ << std::endl;
...
// * Refresh img panel
// */
//void LV_Imgs::refresh_imgs(void) {
//    // Refresh IMGS panel
...
// * Show images
// */
//int LV_Imgs::show_imgs(std::vector<Img> &imgs) {
